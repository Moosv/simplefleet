    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-lg mx-auto px-4 py-4 flex items-center justify-between gap-3">
          ...
          <button
            onClick={() => navigate('/employee/dispatch')}
            className="flex items-center gap-1.5 bg-violet-600 text-white px-3 py-2 rounded-xl text-xs font-semibold hover:bg-violet-700 transition-colors shrink-0"
          >
